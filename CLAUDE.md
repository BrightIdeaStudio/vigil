...
Vigil is a platform health monitor and auto-fix system. It collects errors, analyzes failures, proposes fixes, and can execute them with approval. It is developer-facing (for the platform creator), not user-facing. It is part of the BrightIdeaStudio suite. See `PLAN.md` for the vision document.
...
## Status
Implementation not started. PLAN.md is a vision document. Full implementation plan will be written after Lumen and Atelier are built, as Vigil depends on the inter-project communication layer and agent composition capabilities.
